...
# this script was made for somoneone in the IT club....
...
function ConvertToFileFormat {
    ...
    try {
        ...
        $message = "Error occurred during conversion: $_"
...
$outputFormatDropdown.Items.AddRange(@("pdf", "docx"))
...
$convertButton.Add_Click({
    ...
    $outputFileFormat = $outputFormatDropdown.SelectedItem
    ...
    if (Test-Path $input -PathType Container) {
        ...
        foreach ($file in $files) {
            # Generate the output file path with the appropriateextension
